      ...
      <div className="mx-5 mb-5">
            ...
            <div className="p-3">
                <table className="w-full rounded-lg overflow-hidden">
                    ...
                    <tbody>
                        {TABLE_ROWS.map(({ type, description, Total_price }, index) => {
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <td className="p-2">
                                        ...
                                        <button type="button" class="bg-kgreen focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]">Edit</button>
                                        <button type="button" class="bg-kyellow focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]">Pay</button>
                                        <button type="button" class="bg-kred focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]">Delete</button>
