          ...
          <div className="card_container flex justify-center space-x-20 mt-7">
                ...
                <div className="card2 w-80  h-[26rem] mb-8 bg-kgray backdrop-filter backdrop-blur-lg rounded-xl border-2 border-kyellow">
                        ...
                        <div className="button flex justify-center font-bold">  
                          <button className="btn_buy justify-end items-end w-28 h-12 bg-kyellow rounded-3xl text-center text-kwhite text-base font-bold font-['Inter'] hover:bg-kwhite hover:text-kblack" onClick={() => { selectPackage("Minimal"); setAddSection(true); }}>BUY</button>
                      </div>
                </div>
                ...
                <div className="card3 w-80 h-[26rem] mb-8 bg-kgray backdrop-filter backdrop-blur-lg rounded-xl border-2 border-kyellow">
                        ...
                        <div className="button flex justify-center font-bold">  
                          <button className="btn_buy justify-end items-end w-28 h-12 bg-kyellow rounded-3xl text-center text-kwhite text-base font-bold font-['Inter'] hover:bg-kwhite hover:text-kblack" onClick={() => { selectPackage("Regular"); setAddSection(true); }}>BUY</button>
                      </div>
                </div>
                ...
                <div className="card3 w-80 h-[26rem] mb-8 bg-kgray backdrop-filter backdrop-blur-lg rounded-xl border-2 border-kyellow">
                        ...
                        <div className="button flex justify-center font-bold">  
                          <button className="btn_buy justify-end items-end w-28 h-12 bg-kyellow rounded-3xl text-center text-kwhite text-base font-bold font-['Inter'] hover:bg-kwhite hover:text-kblack" onClick={() => { selectPackage("De-Luxe"); setAddSection(true); }}>BUY</button>
                      </div>
                </div>
