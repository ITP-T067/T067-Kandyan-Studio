        ...
        <div className={`container ${addSection ? 'blur' : ''}`}>
          ...
          <div className="events w-56 h-12 relative mt-15 ml-96 flex justify-center">
            <Link to="/customer/event/WeddingEvents">
              <button className={`Wedding w-56 h-12 left-0 top-0 absolute bg-kgray rounded-tl-3xl rounded-bl-3xl text-center text-kwhite text-xl font-normal hover:bg-kyellow hover:text-kblack ${location.pathname === '/customer/event/WeddingEvents' ? 'bg-kyellow' : ''}`}>Wedding</button>
            </Link>
            <Link to="/customer/event/BdayEvents">
              <button className={`Bdayparty w-56 h-12 left-[232px] top-0 absolute bg-kgray text-center text-kwhite text-xl font-normal  hover:bg-kyellow hover:text-kblack ${location.pathname === '/customer/event/BdayEvents' ? 'active' : ''}`}>Birthday Party</button>
            </Link>
                  ...
                  if (pkg.pkg_name === "Minimal") {
                    return (
                      ...
                      <div key={pkg._id} className="card2 w-80  h-[30rem] mb-8 bg-kgray backdrop-filter backdrop-blur-lg rounded-xl border-2 border-kyellow">
                        ...
                        <div className="button flex justify-center font-bold">
                          <button className="btn_buy justify-end items-end w-28 h-12 bg-kyellow rounded-3xl text-center text-kwhite text-base font-bold hover:bg-kwhite hover:text-kblack" onClick={() => { selectPackage("Minimal"); setAddSection(true); handleId(pkg._id) }}>BUY</button>
                        </div>
                      </div>
                    )
                  }
                    ...
                    return (
                      ...
                      <div key={pkg._id} className="card3 w-80 h-[30rem] mb-8 bg-kgray backdrop-filter backdrop-blur-lg rounded-xl border-2 border-kyellow">
                        ...
                        <div className="button flex justify-center font-bold">
                          <button className="btn_buy justify-end items-end w-28 h-12 bg-kyellow rounded-3xl text-center text-kwhite text-base font-bold hover:bg-kwhite hover:text-kblack" onClick={() => { selectPackage("Regular"); setAddSection(true); handleId(pkg._id) }}>BUY</button>
                        </div>
                      </div>
                    )
                  }
                    ...
                    return (
                      ...
                      <div key={pkg._id} className="card3 w-80 h-[30rem] mb-8 bg-kgray backdrop-filter backdrop-blur-lg rounded-xl border-2 border-kyellow">
                        ...
                        <div className="button flex justify-center font-bold">
                          <button className="btn_buy justify-end items-end w-28 h-12 bg-kyellow rounded-3xl text-center text-kwhite text-base font-bold hover:bg-kwhite hover:text-kblack" onClick={() => { selectPackage("De-Luxe"); setAddSection(true); handleId(pkg._id) }}>BUY</button>
                        </div>
                      </div>
                    )
                  }
