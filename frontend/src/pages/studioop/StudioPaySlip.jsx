    ...
    const fetchSalaryData = async () => {
        ...
        try {
            const response = await axios.get('/salary/salary/', {
                params: { employeeName: "D. Gamage", selectedMonth: formattedMonth },
            });
            ...
            <div className='flex justify-start'>
                <button onClick={GoBack}>
                    <div className="flex items-center">
                        ...
                        <h1 className="text-left text-kwhite text-3xl pr-4 pb-4 ml-7 mt-4">Studio Operator Payroll</h1>
                    </div>
                </button>
            </div>
