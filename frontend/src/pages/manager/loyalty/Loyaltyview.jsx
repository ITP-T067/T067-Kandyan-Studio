  ...
  const getDetails = async () => {
    try {
      ...
      if (response.data.success) {
        const customerID = response.data.data.Cus_ID;
      ...
      <div className={`mx-5 mb-5 ${showEditAlert ? 'blur' : ''} ${showPayAlert ? 'blur' : ''} ${showDeleteAlert ? 'blur' : ''} `}>
        <div className="flex items-center justify-between">
          <div className="flex" onClick={() => navigate('/manager')}>
            ...
            <h2 className="text-3xl font-bold text-kwhite cursor-pointer">Loyalty</h2>
          </div>
          <div className='flex'>
            <button className="bg-kblue text-kwhite p-3 px-5">Generate Report</button>
          </div>
        </div>
      </div>
      <div className="p-3">
        <table className="w-full rounded-lg overflow-hidden">
          ...
          <tbody>
            {Object.keys(details).length > 0 ? (
              ...
              <tr className={`text-kwhite text-center p-4 bg-opacity-20 bg-kyellow
              }`}>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">Kamal</Typography>
                </td>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">1500</Typography>
                </td>
                <td className="text-5xl text-kwhiten">
                  <Typography variant="lead" color="green" className="font-normal">GOLD</Typography>
                </td>
                <td className="p-2">
                  <div className="mx-auto text-kwhite">
                    <button type="button" className="bg-kyellow focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]" onClick={handleViewClick}>View</button>
           ...
           <tr className={`text-kwhite text-center p-4 bg-opacity-20 bg-kred
              }`}>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">Deepal</Typography>
                </td>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">500</Typography>
                </td>
                <td className="text-5xl text-kwhiten">
                  <Typography variant="lead" color="green" className="font-normal">PLATINUM</Typography>
                </td>
                <td className="p-2">
                  <div className="mx-auto text-kwhite">
                    <button type="button" className="bg-kyellow focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]" onClick={handleViewClick}>View</button>
              ...
              <tr className={`text-kwhite text-center p-4 bg-opacity-20  bg-kyellow
                ...
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">Janithi</Typography>
                </td>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">1500</Typography>
                </td>
              ...
              <tr className={`text-kwhite text-center p-4 bg-opacity-20 bg-kred
                ...
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">pahan</Typography>
                </td>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">500</Typography>
                </td>
                <td className="text-5xl text-kwhiten">
                  <Typography variant="lead" color="green" className="font-normal">BRONZE</Typography>
                </td>
                <td className="p-2">
                  <div className="mx-auto text-kwhite">
                    <button type="button" className="bg-kyellow focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]" onClick={handleViewClick}>View</button>
              ...
              <tr className={`text-kwhite text-center p-4 bg-opacity-20 bg-kgray
              }`}>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">Thinal</Typography>
                </td>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">8000</Typography>
                </td>
                <td className="text-5xl text-kwhiten">
                  <Typography variant="lead" color="green" className="font-normal">PLATINUM</Typography>
                </td>
              ...
              <tr className={`text-kwhite text-center p-4 bg-opacity-20  bg-kgray
                ...
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">Sunil</Typography>
                </td>
                <td>
                  <Typography variant="lead" color="blue-gray" className="font-normal">5000</Typography>
                </td>
                <td className="text-5xl text-kwhiten">
                  <Typography variant="lead" color="" className="font-normal">PLATINUM</Typography>
                </td>
                <td className="p-2">
                  <div className="mx-auto text-kwhite">
                    <button type="button" className="bg-kyellow focus:ring-4 focus:outline-none font-medium rounded-3xl text-sm px-5 py-2.5 text-center me-2 mb-2 w-[6rem]" onClick={handleViewClick}>View</button>
