                ...
                <div className='grid grid-cols-3'>
                    <div className="col-span-2 p-3 m-5 text-kwhite bg-kwhite/20 rounded-lg items-center justify-center">
                        <div className='grid grid-cols-3'>
                            ...
                            <select
                                            className="w-full mb-5 rounded-md border-0 py-1.5 text-kblack shadow-sm ring-1 ring-inset ring-kgray focus:ring-2 focus:ring-inset focus:ring-kgreen sm:max-w-xs sm:text-sm sm:leading-6"
                                            id="item"
                                            value={ItemId}
