...
const PerformanceForm = ({ basicSalary }) => {
    ...
    const handleChange = (e) => {
        ...
        let otPayment = formValues.otPayment; // Initialize otPayment with current value
        let noPayDeduction = formValues.noPayDeduction; // Initialize noPayDeduction with current value
