                    ...
                    <>
                        <div className="addContainer w-[530px] h-[450px] bg-kgray bg-opacity-70 rounded-[20px] shadow flex flex-col mt-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-5">
                            ...
                            <form onSubmit={handleUpdate} className="flex flex-col px-5 py-5">
                                ...
                                <input type="text" id="Customer_Name" name="Customer_Name" value={data?.Cus_ID?.Cus_Name || 'N/A'} className="w-[473px] h-[49px] rounded-[10px] mb-0 p-3 text-base bg-kwhite disabled"  />
                                
                                <label htmlFor="Inquiry_Data" className='font-bold text-kwhite text-lg'>Inquiry Data: </label>
                                <input type="text" id="Inquiry_Data" name="Inquiry_Data" value={data?.Inquiry_Data || 'N/A'} className="w-[473px] h-[49px] rounded-[10px] mb-0 p-3 text-base bg-kwhite disabled"  />
                    ...
                    <>
                        <div className="addContainer w-[530px] h-[450px] bg-kgray bg-opacity-70 rounded-[20px] shadow flex flex-col mt-20 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 p-5">
                            ...
                            <form onSubmit={handleUpdate} className="flex flex-col px-5 py-5">
                                ...
                                <input type="text" id="Feedback" name="Feedback" value={formatDate(data?.Inquiry_Resolved_Date)} className="w-[473px] h-[49px] rounded-[10px] mb-0 p-3 text-base text-kblack disabled" />

                                <label htmlFor="Feedback" className='font-bold text-kwhite text-lg'>Feedback: </label>
                                <input type="text" id="Feedback" name="Feedback" value={data?.Feedback} className="w-[473px] h-[49px] rounded-[10px] mb-5 p-3 text-base text-kblack disabled" />
                            </form>
                        </div>
