    ...
    {/*passport wise nav bar */}
      <div className="flex flex-row ">
        ...
        <div className="m-1 rounded-lg bg-kwhite bg-opacity-10 px-full px-5 py-5 w-3/4">
          ...
          <a href='/cashier/addnewstudio'><div class="m-1 rounded-lg bg-kblack text-kwhite px-20 py-5 shadow-xl ring-1 ring-slate-900/5 h-full w-100 transition-transform duration-300 ease-in-out hover:scale-105">Passport
            </div></a>
            <a href='/cashier/identitycard'> <div class="m-1 rounded-lg bg-kblack text-kwhite  px-20 py-5 shadow-xl ring-1 ring-slate-900/5 h-full w-100 transition-transform duration-300 ease-in-out hover:scale-105">Identity Card
            </div></a>
            ...
            <div class="m-1 rounded-lg bg-kblack text-kwhite  px-20 py-5 shadow-xl ring-8 ring-slate-900/5 h-full w-100 ">Product Photo
            </div>
          ...
          <hr className='text-kwhite opacity-30'/>
          <br/>        
